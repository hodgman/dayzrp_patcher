...
namespace ArmaServerInfo
{
    ...
    public class GameServer
    {
        ...
        public GameServer(string host)
            : this(NetworkSettings.GetDefault(host), DefaultName, null)
        { }
        public GameServer(string host, string name)
            : this(NetworkSettings.GetDefault(host), name, null)
        { }
        public GameServer(string host, string name, string description)
        ...
        public GameServer(string host, int port)
            : this(NetworkSettings.GetDefault(host, port), DefaultName, null)
        { }
        public GameServer(string host, int port, string name)
            : this(NetworkSettings.GetDefault(host, port), name, null)
        { }
        public GameServer(string host, int port, string name, string description)
		...
		public class BoolEvent : System.EventArgs
		{
			public bool value;
		}
        /// <summary>
        ...
        /// </summary>
		public event EventHandler<BoolEvent> OnlineStateChanged;
        protected virtual void OnOnlineStateChanged(bool isOnline)
        {
			EventHandler<BoolEvent> handler = OnlineStateChanged;
            if (handler != null)
            {
				handler(this, new BoolEvent { value = IsOnline });
            }
        }
